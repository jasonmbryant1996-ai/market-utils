...
from model_registry import MODEL_REGISTRY   # fetched from the private regime-core
                                             # repo at runtime — see workflow's
                                             # "Fetch private core" step. This file
...
# ── Model registry ────────────────────────────────────────────────────────────
# MODEL_REGISTRY itself now lives in the private regime-core repo (imported
# above) — this public file no longer contains the actual stop%/target/hold
# numbers, only the generic logic that consumes whatever registry it's given.
